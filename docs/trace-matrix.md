...
|---|---|---|---|---|---|---|---|
| A1 | Discover mistakes from transcripts | Data ingestion, Failure mining | transcript import contract, normalized transcript importer | Phase 3 | In progress | Skylar | Current slice is the file-based transcript import MVP described in `docs/plan-a1-transcript-import-contract-mvp.md`. This replaces the stale scaffold-era acceptance posture with a real import contract over current code. |
