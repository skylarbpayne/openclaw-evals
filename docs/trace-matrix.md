...
## Usage notes
- Update readiness status whenever a story changes phase.
- Add links to design docs, PRs, tests, and demo artifacts as implementation starts.
- Do not mark a story Acceptance-tested until evidence exists.
