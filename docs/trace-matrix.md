...
| B1 | Create typed mistake record | Mistake registry | mistake schema, persistence layer | Phase 3 | Not started | Skylar | The A2 slice persists a narrow candidate artifact only. Do not treat that as B1 completion. B2 may extend candidate state minimally for honest reviewability without claiming full B1 completion. |
